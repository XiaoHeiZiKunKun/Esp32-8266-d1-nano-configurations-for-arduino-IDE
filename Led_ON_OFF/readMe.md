...
**delay(1000)** to sleep 1000 milliseconds. To simulate a blink you should setting in the loop() function HIGH and LOW alternatively, coordinating with delay() function.
